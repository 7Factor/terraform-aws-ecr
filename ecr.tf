locals {
  ...
  push_allowed_policy = templatefile("${path.module}/templates/push_policy.tftpl", { push_account_list = var.push_account_list })
  pull_allowed_policy = templatefile("${path.module}/templates/pull_policy.tftpl", { pull_account_list = var.pull_account_list })
}
